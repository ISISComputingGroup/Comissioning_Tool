...
if platform.system() == 'Windows':
  if '64 bit' in platform.python_compiler():
    _gclib_path = os.path.dirname(os.path.abspath(__file__)) + r'\x64\gclib.dll'
    _gclibo_path = os.path.dirname(os.path.abspath(__file__)) + r'\x64\gclibo.dll'
    _gclib = WinDLL(_gclib_path)
    _gclibo = WinDLL(_gclibo_path)
  else:
    _gclib_path = os.path.dirname(os.path.abspath(__file__)) + r'\x86\gclib.dll'
    _gclibo_path = os.path.dirname(os.path.abspath(__file__)) + r'\x86\gclibo.dll'
    _gclib = WinDLL(_gclib_path)
    _gclibo = WinDLL(_gclibo_path)
